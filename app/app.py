...
from resources.usuario import Usuario, RegistroUsuario, LoginUsuario, LogoutUsuario, ConfirmaUsuario
...
api.add_resource(ConfirmaUsuario,'/confirmacao/<int:user_id>')
